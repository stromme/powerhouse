  ...
  <div class="row">
    ...
    <div class="col-xs-12 col-sm-12 col-md-5 col-lg-4">
      <div class="sidebar">
        ...
        <a href="tel:<?=format_phone_plain(get_contact_number())?>" class="show-phone" data-phone="<?=get_contact_number()?>"><span class="glyphicon glyphicon-earphone"></span> Talk to a specialist</a>
