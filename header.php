    ...
    <div class="row">
      ...
      <div class="col-xs-12 col-sm-12 col-md-8 col-lg-7 main-nav-container">
        <div class="main-nav">
          ...
          <a href="" data-toggle="modal" data-target="#estimate" onclick="javascript:if(typeof ga!='undefined' && ga){ga('send', 'event', 'Interest', 'Open web lead', 'Header');}" class="button cta"><span class="hidden-xs">GET AN</span> ESTIMATE</a>
